...
public class OBReadDirectDebit2DataDirectDebit   {
   ...
   **/
  @Schema(description = "A unique and immutable identifier used to identify the direct debit resource. This identifier has no meaning to the account owner.")
   ...
   **/
  @Schema(required = true, description = "Direct Debit reference. For AUDDIS service users provide Core Reference. For non AUDDIS service users provide Core reference if possible or last used reference.")
      @NotNull
   ...
   * @return name
   **/
  @Schema(required = true, description = "Name of Service User.")
      @NotNull
   ...
   **/
  @Schema(description = "Date of most recent direct debit collection.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
