...
public class OBStatement2Detail   {
  ...
  @Valid
  private List<OBStatement2DetailStatementAmount> statementAmount = null;
   ...
   * @return statementId
   **/
  @Schema(description = "Unique identifier for the statement resource within an servicing institution. This identifier is both unique and immutable.")
   ...
   **/
  @Schema(description = "Unique reference for the statement. This reference may be optionally populated if available.")
   ...
   **/
  @Schema(required = true, description = "Date and time at which the statement period starts.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
      @NotNull
   ...
   * @return endDateTime
   **/
  @Schema(required = true, description = "Date and time at which the statement period ends.All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00")
      @NotNull
  ...
  public OBStatement2Detail statementAmount(List<OBStatement2DetailStatementAmount> statementAmount) {
    this.statementAmount = statementAmount;
    return this;
  }

  public OBStatement2Detail addStatementAmountItem(OBStatement2DetailStatementAmount statementAmountItem) {
    if (this.statementAmount == null) {
      this.statementAmount = new ArrayList<OBStatement2DetailStatementAmount>();
    }
  ...
  @Schema(description = "")
      @Valid
    public List<OBStatement2DetailStatementAmount> getStatementAmount() {
    return statementAmount;
  }

  public void setStatementAmount(List<OBStatement2DetailStatementAmount> statementAmount) {
    this.statementAmount = statementAmount;
  }
